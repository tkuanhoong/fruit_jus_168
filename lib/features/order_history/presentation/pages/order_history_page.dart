  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: _buildOrderHistoryCards(
              0), // Replace 5 with the quantity of order's history
        ),
      ),
    );
  }

  List<Widget> _buildOrderHistoryCards(int quantity) {
    List<Widget> cards = [];
    if (quantity == 0) {
      cards.add(
        Card(
                        ...
                        children: [
                          ...
                          const FittedBox(
                            ...
                            child: Image(
                              ...
                              alignment: Alignment.center,
                              image:
                                  AssetImage('assets/images/smalldelivery.png'),
                            ),
                          ),
                          Column(
                            children: [
